...
Viterbi2Docl_Py::Viterbi2Docl_Py(proxyCL_Py& proxy_cl) {
  viterbi = boost::shared_ptr<Viterbi2Docl>(new Viterbi2Docl(dynamic_cast<proxyCL&>(proxy_cl)));
}


bp::tuple Viterbi2Docl_Py::InitCL(const std::string& srcKernelDir, const std::string& binKernelDir,
  bool enable_fp64, size_t num_states, size_t work_group_size)
{
  std::string error;
  bool ret = viterbi->InitCL(srcKernelDir, binKernelDir, error, enable_fp64, num_states, work_group_size);
  return bp::make_tuple(ret, error);
}


void Viterbi2Docl_Py::InitData(bp::dict& stateInfo, bp::dict& params) {
  ...
  viterbi->InitData(maxLen, numStates, trans);
}


bp::list Viterbi2Docl_Py::GetKmerList() const {
  bp::list kmerList;
...
bp::numeric::array Viterbi2Docl_Py::GetModelLevels1() const {
...
bp::numeric::array Viterbi2Docl_Py::GetModelLevels2() const {
...
bp::dict Viterbi2Docl_Py::Call(bp::dict& events1, bp::dict& events2, bp::list& alignment, bp::object& prior) {
  ...
  Alignment alignIn = list_to_pair_vector<int32_t>(alignment);
...
bp::dict Viterbi2Docl_Py::CallPost(bp::numeric::array& post1, bp::numeric::array& post2,
...
void Viterbi2Docl_Py::setupKmers(int kmerLen) {
...
boost::shared_ptr<Emission> Viterbi2Docl_Py::makeEmission(bp::dict& model, bool rc) {
...
boost::shared_ptr<Emission> Viterbi2Docl_Py::dummyEmission(bp::list& kmers) {
...
void Viterbi2Docl_Py::sortModel(vector<double>& levels, vector<double>& levelSpreads, vector<double>& noises,
...
void Viterbi2Docl_Py::getEvents(bp::dict& events, vector<double>& means, vector<double>& stdvs,
...
void Viterbi2Docl_Py::makeBands(const Alignment& alignIn, vector<int32_t>& bandStarts, vector<int32_t>& bandEnds) {
...
bp::dict Viterbi2Docl_Py::makeResult(const Alignment& alignOut, const vector<int16_t>& statesOut) {
  bp::list align;
  bp::list kmersOut;
